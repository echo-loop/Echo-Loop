...
void main() {
  ...
  testWidgets('网页源默认 3/5 屏高，上拉指示条放大、下拉缩小', (tester) async {
    await withLinux(() async {
      ...
      // 默认约 3/5 屏高（受 SafeArea 影响略小，给足容差）
      expect(initial, closeTo(screenH * 0.6, 40));
  ...
  testWidgets('AI 源默认 3/5 屏高，上拉指示条放大', (tester) async {
