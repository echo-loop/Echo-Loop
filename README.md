...
Flutter 跨平台英语听说练习应用，支持 macOS / iOS / Android / Web。围绕真实音频材料，提供「首次学习→间隔复习→毕业检验」的完整学习闭环：盲听理解大意、逐句精听标注难点、跟读模仿发音、复述锻炼输出，配合 9 阶段间隔复习（R1-R28）巩固记忆，最终实现脱离字幕流利跟读与复述。
